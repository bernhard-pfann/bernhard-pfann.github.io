...
:one: Created a game engine of the UNO card game from scratch<br>
:two: Obtained game statistics from simulating a series of 100,000 games<br>
:three: Implemented Reinforcement Learning agent (Q-Learning, Monte Carlo) in order to discover an optimal game strategy<br>
:four: [Published article](https://bernhard-pfann.medium.com/tackling-uno-card-game-with-reinforcement-learning-fad2fc19355c)<br>
